...
export const Layers3: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <path d="m12.83 2.18-7.9 4.93a2 2 0 0 0-1.03 1.74v8.3a2 2 0 0 0 1.03 1.74l7.9 4.93c.57.36 1.23.36 1.8 0l7.9-4.93a2 2 0 0 0 1.03-1.74v-8.3a2 2 0 0 0-1.03-1.74l-7.9-4.93c-.57-.36-1.23-.36-1.8 0z"/>
    <path d="m22 7-8.2 5.13a2 2 0 0 1-1.6 0L4 7"/>
    <path d="m4 17 8.2-5.13a2 2 0 0 0 1.6 0L22 17"/>
  </svg>
);
